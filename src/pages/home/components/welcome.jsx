...
const welcome = () => {
	return (
        <>
            <div>
            <div className="bg-gradient-to-r from-lime-400  font-['Rubik'] py-16 -3xl mx-10 rounded-bl-2xl md:rounded-bl-full ">
                <div className="text-center  font-bold text-4xl ">
                <h1 className="font-extrabold text-transparent text-lg md:text-5xl bg-clip-text bg-gradient-to-r from-orange-500  to-lime-500">Apakah Sudah Terkoneksi Internet !</h1>
                </div><br/>
                <div className="text-center text-black font-bold text-base md:text-2xl ">
