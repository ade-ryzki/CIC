...
const parttwo = () => {
    ...
    <>
        ...
        <div className="hero-content flex-col lg:flex-row">
            ...
            <p className="py-6 text-lg text-justify">CIC merupakan perusahaan <a className="font-semibold">Internet Service Provider</a> yang menyediakan berbagai solusi IT lengkap seperti internet, IPTV, hosting, dan beberapa produk lainnya. Untuk mengetahui produk apa saja yang ada di CIC, silahkan klik tombol "Product"</p>
            <Link to='/product'>
